<div class="container-fluid" id="colonosMapApp">
	...
	<div class="row">
		<div class="col-md-7 mapside">
        	<div id="mapView"></div>
        </div>
        <div class="col-md-5 dataside">
        	<div class="row">
	        	<div class="col-md-12 dataresult">
	        		<div class="wrapper">
						<p><strong>We found 9 results for your research.</strong></p>		        		
...
<script src="./public/lib/jquery-1.10.2.min.js"></script>
<script src="./public/lib/bootstrap/js/bootstrap.min.js"></script>
<script src="./public/lib/leaflet/leaflet.js"></script>
<script src="./public/lib/raty/jquery.raty.js"></script>
<script src="./public/js/app.js"></script>
<script src="./public/lib/json2.js"></script>
<!-- Replace with  .min version for production-->
<script src="./public/lib/underscore.js"></script>
<script src="./public/lib/backbone.js"></script>
<!-- <script src="./public/js/bbapp.js"></script> -->
