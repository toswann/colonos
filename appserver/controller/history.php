<?php
/**
 * History Controller for all operations from Users perspective.
 * @package Front End Module
 * @category History Controller      
...
class History extends Controller {
    ...
    public function index() {
        ...
        $history = C::D('SIDENAV_DEFAULT_CLASS');        
        require_once APP_FOLDER_NAME.'/views/_templates/_mainpage_header.php';
        require_once APP_FOLDER_NAME.'/views/history/index.php';
